...
- (BOOL)acceptOnInterface:(NSString *)interface port:(UInt16)port error:(NSError **)errPtr
{
	...
	int reuseOn = 1;//0x0004 SO_REUSEADDR
	if (theSocket4)	setsockopt(CFSocketGetNative(theSocket4), IPPROTO_TCP, TCP_NODELAY, &reuseOn, sizeof(reuseOn));
	if (theSocket6)	setsockopt(CFSocketGetNative(theSocket6), IPPROTO_TCP, TCP_NODELAY, &reuseOn, sizeof(reuseOn));
